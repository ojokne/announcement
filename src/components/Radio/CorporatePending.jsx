        ...
        if (announcements.hasOwnProperty("announcements")) {
          ...
          if (announcementsArray.length > 0) {
            for (let i = 0; i < announcementsArray.length; i++) {
              ...
              if (
                announcement.category.toLowerCase() === "corporate" &&
        ...
        {display && (
          ...
          >
            <Typography variant="h5" color="secondary" sx={{ padding: 2 }}>
              Pending Corporate announcements
            </Typography>
            {pending.map((announcement, index) => {
              return (
                <AnnouncementSummary
                  ...
                  key={index}
                  backLink="/radio/corporate/pending"
                />
              );
            })}
          </Box>
...
export default CorporatePending;
